(function(){
		...
		createControl : function(id, controlManager) {
			...
			if (id == 'nb_btn') {
				...
				var nb_sc_button = controlManager.createButton('nb_btn', {
					title : 'Swift Box Shortcode', // title of the button
					image : '../wp-content/plugins/news-box-wp/img/nb_tinymce_btn.png',  // path to the button's image
					onclick : function() {
						tb_show('Swift Box Shortcode', '#TB_inline?width=' + nb_W + '&height=' + nb_H + '&inlineId=nb-shortcode-form');
	...
	jQuery('body').delegate('#nb-shortcode-submit', 'click', function(){	
		var shortcode = '[swiftbox id="'+ jQuery('#nb_box_id').val() +'"]';
